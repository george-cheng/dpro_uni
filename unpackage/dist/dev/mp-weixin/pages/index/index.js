...
/***/ 59:
/*!*****************************************************************************!*\
  !*** E:/gitwork/dpro_uni/dpro_uni/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \*****************************************************************************/
...
/***/ 60:
/*!**********************************************************!*\
  !*** E:/gitwork/dpro_uni/dpro_uni/pages/index/index.vue ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ 61:
/*!*****************************************************************************************!*\
  !*** E:/gitwork/dpro_uni/dpro_uni/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*****************************************************************************************/
...
/***/ 62:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--16-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/gitwork/dpro_uni/dpro_uni/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var l0 = _vm.__map(_vm.moneyData, function(item, index) {
    ...
    var m0 = index < 3 ? parseFloat(item.fupanddown) : null
    var g0 =
      index < 3 ? _vm.accMul(item.lastDealPrize, _vm.usdtRate).toFixed(2) : null
    return {
      $orig: $orig,
      m0: m0,
      g0: g0
  ...
  var l1 = _vm.__map(_vm.market, function(item, index) {
    var $orig = _vm.__get_orig(item)

    var m1 = index < 10 ? parseFloat(item.fupanddown) : null
    return {
      $orig: $orig,
      m1: m1
    }
...
/***/ 63:
/*!***********************************************************************************!*\
  !*** E:/gitwork/dpro_uni/dpro_uni/pages/index/index.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 64:
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/gitwork/dpro_uni/dpro_uni/pages/index/index.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  methods: {
    getMsg: function getMsg() {var _this = this;
      var data = { page: 1, pageSize: 1, type: 1 };
      this.ajaxJson({
        url: '/api/v1/articleList',
        method: 'POST',
        data: data,
        call: function call(res) {
          _this.msg = res.data.rows;
        } });
    ...
    getMarket: function getMarket() {var _this2 = this;
      this.ajaxJson({
        ...
        call: function call(res) {
          _this2.market = res.dataMap.USDT;
        } });

    },
    getMoneyData: function getMoneyData() {var _this3 = this;
      this.ajaxJson({
        url: '/api/v2/market/coins',
        call: function call(res) {
          _this3.moneyData = res.dataMap.USDT;
        } });

      uni.getStorage({
        key: 'rate',
        success: function success(res) {
          _this3.rate = res.data;
          _this3.usdtRate = _this3.rate.usdt;
        } });

    },
    getImg: function getImg() {var _this4 = this;
      var data = { via: 'app' };
      this.ajaxJson({
        url: '/api/v1/config/banner',
        data: data,
        call: function call(res) {
          _this4.swipers = res.data;
        } });

    },
    getExchangeRate: function getExchangeRate() {var _this5 = this;
      this.ajaxJson({
        url: '/api/v2/market/getUsdtPrice',
        call: function call(res) {
          _this5.rate = res.data;
          uni.setStorage({
            key: 'rate',
            data: _this5.rate,
    ...
    upDateConfirm: function upDateConfirm() {var _this7 = this;
      ...
      var downLoadTime;
      downLoadTime = setInterval(function () {
        _this7.progressFile = parseInt(totalBytesWritten / totalBytesExpectedToWrite * 100);
        if (_this7.progressFile >= 100) {
...
/***/ 65:
/*!********************************************************************************************!*\
  !*** E:/gitwork/dpro_uni/dpro_uni/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 66:
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!E:/gitwork/dpro_uni/dpro_uni/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
